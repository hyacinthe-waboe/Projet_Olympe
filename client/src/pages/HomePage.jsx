...
// Normalement, celles-ci seraient dans des fichiers séparés (ex: /src/assets/icons/PhoneIcon.jsx)
// Mais pour un exemple tout-en-un, nous les définissons ici.
...
const Sidebar = () => (
    <div className="h-screen bg-white border-r border-gray-200 flex flex-col items-center py-4 space-y-6">
        <div className="w-12 h-12 bg-gray-800 text-white flex items-center justify-center rounded-lg font-bold">LOGO</div>
  ...
  return (
    <div className="flex h-screen bg-gray-100 font-sans">
      ...
      <div className="flex flex-col flex-1">
        {/* Header (non détaillé dans la maquette, mais nécessaire) */}
