...
import logo from '../assets/logo.png'; // <-- Importez votre logo ici (ajustez le chemin si nécessaire)
...
// Composant: Barre latérale principale
const Sidebar = () => (
    <div className="h-screen bg-white border-r border-gray-200 flex flex-col items-center py-4 space-y-6">
        {/* --- MODIFICATION ICI : Remplacement du texte "LOGO" par l'image --- */}
        <div className="w-12 h-12 flex items-center justify-center rounded-lg">
            <img src={logo} alt="Logo Projet Olympe" className="w-full h-full object-contain" />
        </div>
        <nav className="flex flex-col items-center space-y-4">
            <button className="p-3 bg-gray-100 rounded-lg text-gray-700"><HomeIcon /></button>
            <button className="p-3 text-gray-500 hover:bg-gray-100 rounded-lg"><LayoutDashboardIcon /></button>
            <button className="p-3 text-gray-500 hover:bg-gray-100 rounded-lg"><PhoneIcon /></button>
            <button className="p-3 text-gray-500 hover:bg-gray-100 rounded-lg"><UserIcon /></button>
            <button className="p-3 text-gray-500 hover:bg-gray-100 rounded-lg"><CalendarIcon /></button>
            <button className="p-3 text-gray-500 hover:bg-gray-100 rounded-lg"><MailIcon /></button>
            <button className="p-3 text-gray-500 hover:bg-gray-100 rounded-lg"><FileTextIcon /></button>
        </nav>
    </div>
);
            ...
            <div className="flex items-center space-x-4">
                ...
                <nav className="flex items-center space-x-2">
                    ...
                    <button className="p-2 text-gray-500 hover:bg-gray-100 rounded-lg relative" title="Notifications">
                        <BellIcon />
                        {/* Vous pouvez ajouter un point de notification ici */}
                ...
                {/* --- AJOUT - Profil utilisateur mis à jour --- */}
